//
//  FinalizacaoCadastroView.swift
//  Teste
//
//  Created by user220210 on 8/5/22.
//

import UIKit

class FinalizacaoCadastroView: UIViewController {
    ...
    let titleLabel: UILabel = {
        ...
        titleLabel.font = UIFont(name: "Arial", size: 70) // FONTE: KoHo
    ...
    let subtitleLabel: UILabel = {
        ...
        subtitleLabel.font = UIFont(name: "Arial", size: 20) // FONTE: Ubuntu
