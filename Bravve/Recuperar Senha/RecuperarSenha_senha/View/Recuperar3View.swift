...
class RecuperacaoDeSenha3: UIViewController {
    ...
    private var passwordEyeSlash = false
    private var confirmPasswordEyeSlash = false
    private var containsUppercased = false
    private var containsLowercased = false
    private var textInsideRange = false
    private var containsSpecialCharacters = false
    private var containsNumericCharacters = false
