...
class PhoneView: UIViewController {
    ...
    private func setupConstraints() {
        ...
        viewElements.ddisButton.translatesAutoresizingMaskIntoConstraints = false
        ...
        viewElements.ddisButton.centerYAnchor.constraint(equalTo: registerStackView.centerYAnchor).isActive = true
        viewElements.ddisButton.leadingAnchor.constraint(equalTo: registerStackView.leadingAnchor, constant: CGFloat(50).generateSizeForScreen).isActive = true
        ...
        viewElements.leftStackView.widthAnchor.constraint(equalToConstant: CGFloat(50).generateSizeForScreen).isActive = true
        viewElements.ddisButton.widthAnchor.constraint(equalToConstant: CGFloat(30).generateSizeForScreen).isActive = true
    }
    //MARK: setupTargets
